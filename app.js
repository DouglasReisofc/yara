    ...
    case '!updatebot':
      if (msg.hasMedia) {
        ...
        if (media.mimetype === 'application/javascript') { // Verifica se é um arquivo .js
          const filePath = './app.js'; // Caminho do arquivo no servidor
          ...
          client.sendMessage(msg.from, '⚠️ Envie um arquivo válido (`app.js`)!');
        }
      } else {
        client.sendMessage(msg.from, '⚠️ Você precisa anexar um arquivo `app.js` para atualizar o bot!');
      }
      break;
